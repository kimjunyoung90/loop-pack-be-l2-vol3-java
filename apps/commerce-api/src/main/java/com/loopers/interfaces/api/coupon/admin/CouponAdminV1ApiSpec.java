...
public interface CouponAdminV1ApiSpec {
    ...
    ApiResponse<PageResponse<CouponDetailResponse>> getCoupons(Pageable pageable);
    ...
    ApiResponse<PageResponse<IssuedCouponListResponse>> getIssuedCoupons(Long couponId, Pageable pageable);
}
